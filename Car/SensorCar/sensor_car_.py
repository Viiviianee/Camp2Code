    ...
    def fahrmodus5(self, speed, driving_back=False):
        ...
        while True:
            ...
            if self.val_from_infrared == [1, 1, 1, 1, 1]:
                ...
                self._stop_and_log()
                break
            elif self.val_from_infrared == [1, 0, 0, 0, 0] or self.val_from_infrared == [1, 1, 0, 0, 0] or self.val_from_infrared == [1, 1, 1, 0, 0]:
                if driving_back:
            ...
            elif self.val_from_infrared == [0, 0, 0, 0, 1] or self.val_from_infrared == [0, 0, 0, 1, 1] or self.val_from_infrared == [0, 0, 1, 1, 1]:
                if driving_back:
